...
ALLOWED_HOSTS = ['https://onlineexamportal.onrender.com']
...
EMAIL_RECEIVING_USER = ['rahulsurwade08@gmail.com'] # email on which you will receive messages sent from website
